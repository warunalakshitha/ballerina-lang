...
import static org.wso2.ballerinalang.compiler.bir.codegen.JvmConstants.CALL_SITE;
...
import static org.wso2.ballerinalang.compiler.bir.codegen.JvmConstants.INVOKE_METHOD_TYPE;
...
import static org.wso2.ballerinalang.compiler.bir.codegen.JvmConstants.METHOD_HANDLE;
import static org.wso2.ballerinalang.compiler.bir.codegen.JvmConstants.METHOD_HANDLES_LOOKUP;
...
import static org.wso2.ballerinalang.compiler.bir.codegen.JvmConstants.RUNNABLE;
...
public final class JvmSignatures {
    ...
    public static final String ADD_VALUE_CREATOR = "(L" + STRING_VALUE + ";L" + STRING_VALUE + ";L" + STRING_VALUE +
            ";ZL" + VALUE_CREATOR + ";)V";
    public static final String ALT_RECEIVE_CALL = "(L" + STRAND_CLASS + ";L" + WORKER_CHANNEL_MAP + ";[L" +
    ...
    public static final String BOBJECT_CALL = "(L" + STRAND_CLASS + ";L" + STRING_VALUE + ";[L" + OBJECT + ";)L" +
            OBJECT + ";";
    ...
    public static final String CREATE_RE_CAPTURING_GROUP = "(L" + B_STRING_VALUE + ";L" + OBJECT + ";L" +
            REG_EXP_DISJUNCTION + ";L" + B_STRING_VALUE + ";)L" + REG_EXP_CAPTURING_GROUP + ";";
    ...
    public static final String CREATE_RE_FLAG_EXPR =
            "(L" + B_STRING_VALUE + ";L" + REG_EXP_FLAG_ON_OFF + ";L" + B_STRING_VALUE + ";)L" +
                    REG_EXP_FLAG_EXPR + ";";
    ...
    public static final String CREATE_RECORD_WITH_MAP = "(L" + STRING_VALUE + ";)L" + MAP_VALUE + "<L" + STRING_VALUE +
            ";L" + OBJECT + ";>;";
    ...
    public static final String CREATE_XML_ELEMENT = "(L" + B_XML_QNAME + ";L" + B_STRING_VALUE + ";Z)L" + XML_VALUE +
            ";";
    ...
    public static final String CURRENT_MODULE_INIT = "(L" + BAL_RUNTIME_IMPL + ";)V";
    public static final String CURRENT_MODULE_STOP = "(L" + BAL_RUNTIME_IMPL + ";)V";
    ...
    public static final String ERROR_INIT = "(L" + TYPE + ";L" + B_STRING_VALUE + ";L" + BERROR + ";L" + B_MAP + ";)V";
    public static final String FP_CALL = "(L" + BAL_RUNTIME + ";" + "[L" + OBJECT + ";)L" + OBJECT + ";";
    ...
    public static final String FUNCTION_CALL = "(L" + STRAND_CLASS + ";L" + STRING_VALUE + ";[L" + OBJECT + ";)L" +
            OBJECT + ";";
    public static final String GET_ANNOTATION_VALUE = "(L" + TYPEDESC_VALUE + ";L" + B_STRING_VALUE + ";)L" + OBJECT +
            ";";
    ...
    public static final String GET_BAL_RUNTIME = "L" + BAL_RUNTIME_IMPL + ";";
    ...
    public static final String INIT_CLASS_CONSTRUCTOR = "(L" + BAL_RUNTIME_IMPL + ";)V";
    public static final String INIT_CONFIG = "(L" + MAP + ";" + "[L" + STRING_VALUE + ";[L" + PATH + ";L" +
            STRING_VALUE + ";L" + BAL_RUNTIME_IMPL + ";)V";
    ...
    public static final String INIT_ERROR_WITH_TYPE = "(L" + TYPE + ";L" + B_STRING_VALUE + ";L" + BERROR + ";L" +
            B_MAP + ";)V";
    public static final String INIT_FIELD_IMPL = "(L" + TYPE + ";L" + STRING_VALUE + ";JZ)V";
    ...
    public static final String INIT_INTERSECTION_TYPE_WITH_REFERENCE_TYPE = "(L" + STRING_VALUE + ";L" + MODULE +
            ";[L" + TYPE + ";L" + INTERSECTABLE_REFERENCE_TYPE + ";IZ)V";
    public static final String INIT_INTERSECTION_TYPE_WITH_TYPE = "(L" + STRING_VALUE + ";L" + MODULE + ";[L" + TYPE +
            ";L" + TYPE + ";IZ)V";
    ...
    public static final String INIT_OBJECT_ARRAY_RETURN_OBJECT = "[L" + OBJECT + ";)L" + OBJECT + ";";
    ...
    public static final String INIT_SIGNAL_LISTENER = "(L" + BAL_RUNTIME_IMPL + ";)V";
    ...
    public static final String INIT_TABLE_VALUE_IMPL = "(L" + TYPE + ";L" + ARRAY_VALUE + ";L" + ARRAY_VALUE + ";)V";
    ...
    public static final String INIT_XML_QNAME = "(L" + B_STRING_VALUE + ";L" + B_STRING_VALUE + ";L" + B_STRING_VALUE +
            ";)V";
    public static final String INITIAL_METHOD_DESC = "(L" + STRAND_CLASS + ";";
    public static final String INSTANTIATE = "()L" + OBJECT + ";";
    public static final String INSTANTIATE_WITH_INITIAL_VALUES = "([L" + B_INITIAL_VALUE_ENTRY + ";)L" + OBJECT + ";";
    public static final String INT_VALUE_OF_METHOD = "(I)L" + INT_VALUE + ";";
    public static final String INTI_VARIABLE_KEY = "(L" + MODULE + ";L" + STRING_VALUE + ";L" + TYPE + ";L" +
            STRING_VALUE + ";Z)V";
    ...
    public static final String LAMBDA_META_FACTORY_DESC = "(L" + METHOD_HANDLES_LOOKUP + ";L" + STRING_VALUE + ";L" +
            INVOKE_METHOD_TYPE + ";L" + INVOKE_METHOD_TYPE + ";L" + METHOD_HANDLE + ";L" + INVOKE_METHOD_TYPE + ";)L" +
            CALL_SITE + ";";
    ...
    public static final String LOAD_TYPE_ANNOTATIONS = "(L" + RUNNABLE + ";)V";
    ...
    public static final String METHOD_TYPE_IMPL_INIT = "(L" + STRING_VALUE + ";L" + MODULE + ";L" + OBJECT_TYPE_IMPL +
            ";L" + FUNCTION_TYPE_IMPL + ";J)V";
    ...
    public static final String MULTIPLE_RECEIVE_CALL = "(L" + STRAND_CLASS + ";L" + WORKER_CHANNEL_MAP + ";L" + MAP +
            ";L" + TYPE + ";)L" + B_MAP + ";";
    ...
    public static final String PASS_OBJECT_ARRAY_RETURN_OBJECT = "([L" + OBJECT + ";)L" + OBJECT + ";";
    ...
    public static final String POPULATE_CONFIG_DATA = "(L" + BAL_RUNTIME_IMPL + ";)[L" + VARIABLE_KEY + ";";
    ...
    public static final String RECEIVE_DATA =
            "(L" + STRAND_CLASS + ";L" + WORKER_CHANNEL_MAP + ";L" + STRING_VALUE + ";" + ")L" + OBJECT + ";";
    ...
    public static final String RECORD_GET_FIELD_DEFAULT_VALUE = "(L" + STRAND_CLASS + ";L" + STRING_VALUE + ";L" +
            RECORD_TYPE_IMPL + ";)L" + OBJECT + ";";
    ...
    public static final String RECORD_TYPE_IMPL_INIT = "(L" + STRING_VALUE + ";L" + STRING_VALUE + ";L" + MODULE +
            ";JZI)V";
    ...
    public static final String RESOURCE_METHOD_TYPE_IMPL_INIT =
            "(L" + STRING_VALUE + ";L" + MODULE + ";L" + OBJECT_TYPE_IMPL + ";L" + FUNCTION_TYPE_IMPL + ";[L" + TYPE +
    ...
    public static final String RETURN_FUNCTION = ")L" + FUNCTION + ";";
    ...
    public static final String RETURN_MAP = "()L" + MAP + ";";
    ...
    public static final String RETURN_RUNNABLE = "()L" + RUNNABLE + ";";
    ...
    public static final String WORKER_CHANNELS_ADD = "(L" + WORKER_CHANNEL_MAP + ";[L" + STRING_VALUE + ";)V";
    public static final String WORKER_CHANNELS_COMPLETE = "(L" + WORKER_CHANNEL_MAP + ";L" + OBJECT + ";[L" +
            STRING_VALUE + ";[L" + STRING_VALUE + ";)V";
    public static final String WORKER_CHANNELS_COMPLETE_WITH_PANIC = "(L" + WORKER_CHANNEL_MAP + ";L" + THROWABLE +
