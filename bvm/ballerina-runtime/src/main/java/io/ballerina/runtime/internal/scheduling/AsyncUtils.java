...
public class AsyncUtils {
    ...
    public static void getArgsWithDefaultValues(Scheduler scheduler, Callback callback, ValueCreator valueCreator,
    ...
    public static void invokeDefaultValueFunctions(ValueCreator valueCreator, MapValue<BString, Object> recordValue) {
        ...
        Iterator<Map.Entry<String, Field>> fieldsItr = fields.entrySet().iterator();
        Strand parent = Scheduler.getStrand();
        BRecordField defaultValueField = getNextRecordFieldWithDefaultFunc(fieldsItr, recordType, recordValue);
        if (defaultValueField != null) {
            blockStrand(parent);
            invokeDefaultValueFunctions(valueCreator, fieldsItr, parent, recordType, recordValue,
                    defaultValueField);
        }
    ...
    private static void invokeDefaultValueFunctions(ValueCreator valueCreator,
                                                    ...
                                                    BRecordType recordType, MapValue<BString, Object> recordValue,
        ...
        AsyncFunctionCallback callback = new AsyncFunctionCallback(parent) {
            ...
            public void notifySuccess(Object result) {
                ...
                BRecordField nextDefaultValueField = getNextRecordFieldWithDefaultFunc(fieldsItr, recordType, recordValue);
                if (nextDefaultValueField != null) {
                    invokeDefaultValueFunctions(valueCreator, fieldsItr, parent, recordType, recordValue,
                            nextDefaultValueField);
                }
        ...
        parent.scheduler.schedule(new Object[]{}, defaultFunc, future);
    }
    ...
    private static BRecordField getNextRecordFieldWithDefaultFunc(Iterator<Map.Entry<String, Field>> fieldsItr,
        ...
        while (fieldsItr.hasNext()) {
            ...
            if (defaultFunctionName == null || recordValue.containsKey(field.getFieldName())) {
                continue;
            }
            return field;
        }
